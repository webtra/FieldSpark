...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-[#BCDA84]': style == 'success', 'bg-red-700': style == 'danger' }">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded" :class="{ 'bg-blue-600': style == 'success', 'bg-red-600': style == 'danger' }">
                        ...
                        <p class="ms-3 font-medium text-xs text-white truncate">
                            {{ message }}
                        </p>
                    </div>
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            type="button"
                            class="-me-1 flex p-2 rounded focus:outline-none sm:-me-2 transition"

<template>
    ...
    <div class="min-h-screen flex flex-col">
                ...
                <nav class="absolute inset-y-0 w-full bg-[#00434b] text-white overflow-y-auto">
                    ...
                    <div class="py-4">
                        <ul>
                            ...
                            <li>
                                <Link :href="route('agrochemical.program.index')"
                                    class="flex items-center pl-6 py-2.5 space-x-3 text-white border-l-4 border-[#00434b] hover:border-[#BCDA84] hover:bg-[#003C43]"
                                    :class="{ 'border-l-4 border-[#BCDA84] bg-[#003C43] text-white': $page.url === '/agrochemical-program' }">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="size-5">
                                    <path fill-rule="evenodd"
        ...
        <main class="flex-grow lg:ml-64  bg-gray-100 text-xs z-10">
                            ...
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    ...
                                    <span v-else class="inline-flex rounded-lg">
                                        <button type="button"
                                            class="inline-flex items-center px-3 py-2 border border-transparent text-xs leading-4 font-medium rounded-l text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">

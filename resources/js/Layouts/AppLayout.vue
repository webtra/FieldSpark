<template>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <footer class="lg:ml-64 bg-gray-100 text-white py-3 border-t border-gray-200">
            <p class="text-center text-xs text-gray-400">© 2025 FieldSpark by Webtra (Pty) Ltd. Version 1.0.0. All rights reserved.</p>
        </footer>
    </div>
</template>
...
const props = defineProps({
    ...
    pageTitle: {
        type: String,
        required: true, // Ensure that pageTitle is provided
    },
    breadcrumbs: {
        type: Array,
        required: true, // Ensure that breadcrumbs are provided
    },
});

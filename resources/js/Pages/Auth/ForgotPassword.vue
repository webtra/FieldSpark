            ...
            <form @submit.prevent="submit">
                <div>
                    ...
                    <TextInput id="email" v-model="form.email" type="email" placeholder="Email Address"
                               class="border-white/10 text-white placeholder:text-white/50 placeholder:font-light mt-1 block w-full bg-[#1A565D] rounded text-xs focus:border-[#BCDA84] focus:ring-[#BCDA84]" required />

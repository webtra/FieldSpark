    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-xs text-gray-600">
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-xs text-gray-600">
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-xs bg-gray-100 rounded-lg">
